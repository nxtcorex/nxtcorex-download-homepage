    ...
    if (release) {
      ...
      if (asset) {
        return asset.browser_download_url
          .replace('https://github.com/ZalithLauncher/ZalithLauncher2/releases/download/', 'https://cdn1.download.anycast.ren/dl/zl2/')
      }
    }

    const archSuffix = arch === 'universal' ? '' : `-${arch}`
    const normalizedVersion = normalizeVersionForFilename(version)
    return `https://cdn1.download.anycast.ren/dl/zl2/${version}/ZalithLauncher-${normalizedVersion}${archSuffix}.apk`
  }
          ...
          <div className="bg-brand-bg-secondary border border-white/[0.07] rounded-lg p-6">
            ...
            <div className="bg-brand-bg border border-white/[0.05] rounded p-4">
              ...
              <div>
                ...
                <a
                  href="https://cdn1.download.anycast.ren/dl/zl2/2.0.0_beta-20250920a/ZalithLauncher-2.0.0_beta-20250920a-x86_64.apk"
                  className="text-brand-orange text-xs font-mono break-all hover:underline block"
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  https://cdn1.download.anycast.ren/dl/zl2/2.0.0_beta-20250920a/ZalithLauncher-2.0.0_beta-20250920a-x86_64.apk
                </a>
              </div>
            </div>
          </div>
