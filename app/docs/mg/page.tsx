      ...
      <div className="flex-grow pt-24 pb-16 px-12">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap gap-4 mb-8">
            <a
              href="https://cdn1.download.anycast.ren/dl/mc/mobileglues/latest/app-release.apk"
          ...
          <div className="bg-brand-bg-secondary border border-white/[0.07] rounded-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center gap-2 sm:gap-4">
              <span className="text-brand-text-secondary text-sm min-w-[120px]">最新版本APK:</span>
              <a
                href="https://cdn1.download.anycast.ren/dl/mc/mobileglues/latest/app-release.apk"
                ...
                rel="noopener noreferrer"
              >
                https://cdn1.download.anycast.ren/dl/mc/mobileglues/latest/app-release.apk
              </a>
            </div>
          </div>
        </div>
