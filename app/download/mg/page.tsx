...
export const metadata: Metadata = {
  title: 'MG渲染器下载 - nxtcorex下载加速',
  description: 'MG (MobileGlues) 渲染器下载',
}

const downloadUrl = 'https://cdn1.download.nxtcorex.top/dl/mc/mobileglues/latest/app-release.apk'
    ...
    <main className="flex min-h-screen flex-col bg-background text-foreground">
      ...
      <div className="flex-grow border-b pt-24 pb-16">
        <div className="section-shell max-w-4xl">
          ...
          <div className="mb-8">
            <h1 className="mb-4 text-4xl font-semibold tracking-normal text-foreground">MG (MobileGlues)</h1>
            <p className="text-lg text-muted-foreground">MG渲染器</p>
          </div>
          ...
          <Card className="border bg-card/80">
            <CardHeader>
              <CardTitle className="text-xl font-medium">下载链接</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid gap-2 sm:grid-cols-[120px_1fr] sm:items-center">
                <span className="text-sm text-muted-foreground">最新版本APK:</span>
